...
export interface paths {
    ...
    "/api/v1/admin/factories/options": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** Admin Factory Options */
        get: operations["admin_factory_options_api_v1_admin_factories_options_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/admin/orders/{order_id}/incoming-differences/{record_id}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        options?: never;
        head?: never;
        /** Update Incoming Difference Quantity */
        patch: operations["update_incoming_difference_quantity_api_v1_admin_orders__order_id__incoming_differences__record_id__patch"];
        trace?: never;
    };
    ...
    "/api/v1/admin/shipments/factory-options": {
        ...
        /** Admin Shipment Factory Options */
        get: operations["admin_shipment_factory_options_api_v1_admin_shipments_factory_options_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/admin/shipments/summary": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get: operations["admin_shipment_summary_api_v1_admin_shipments_summary_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/agent-files/{file_id}/download": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** Download Agent File */
        get: operations["download_agent_file_api_v1_agent_files__file_id__download_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/agent-shipments/daily-export/{factory_id}/{business_date}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** Export Agent Daily Shipments */
        get: operations["export_agent_daily_shipments_api_v1_agent_shipments_daily_export__factory_id___business_date__get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/agent-shipments/{shipment_id}/export": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** Export Agent Shipment */
        get: operations["export_agent_shipment_api_v1_agent_shipments__shipment_id__export_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/integrations/feishu/card-actions": {
        ...
        put?: never;
        /** Card Actions */
        post: operations["card_actions_api_v1_integrations_feishu_card_actions_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/integrations/feishu/events": {
        ...
        put?: never;
        /** Events */
        post: operations["events_api_v1_integrations_feishu_events_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        /** IncomingDifferenceUpdateRequest */
        IncomingDifferenceUpdateRequest: {
            /** Quantity */
            quantity: number;
            /** Version */
        ...
        ShipmentSummaryListResponse: {
            /** Items */
            items: components["schemas"]["ShipmentSummaryResponse"][];
            /** Total */
            total: number;
        };
...
export interface operations {
    ...
    admin_factory_options_api_v1_admin_factories_options_get: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    update_incoming_difference_quantity_api_v1_admin_orders__order_id__incoming_differences__record_id__patch: {
        parameters: {
            query?: never;
            header?: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["IncomingDifferenceUpdateRequest"];
            };
        };
        responses: {
            /** @description Successful Response */
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["IncomingDifferenceUpdateResponse"];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    admin_shipment_factory_options_api_v1_admin_shipments_factory_options_get: {
        parameters: {
            query?: never;
            header?: {
                authorization?: string | null;
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["ShipmentFactoryOptionsResponse"];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    admin_shipment_summary_api_v1_admin_shipments_summary_get: {
        parameters: {
            query?: {
                keyword?: string;
                factory?: string;
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["ShipmentSummaryListResponse"];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    download_agent_file_api_v1_agent_files__file_id__download_get: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    export_agent_daily_shipments_api_v1_agent_shipments_daily_export__factory_id___business_date__get: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    export_agent_shipment_api_v1_agent_shipments__shipment_id__export_get: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    card_actions_api_v1_integrations_feishu_card_actions_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    events_api_v1_integrations_feishu_events_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
