...
type DetailRow = { key: string; skuId: string; productName: string; propertiesValue: string; factoryName: string; contractShipDate: string; orderQuantity: number; shippedQuantity: number; pendingQuantity: number; progressPercent: number };
