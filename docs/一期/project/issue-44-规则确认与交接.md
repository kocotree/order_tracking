...
> **2026-09-08 状态核验：** 已由 [PR #48](https://github.com/kocotree/order_tracking/pull/48) 合并，Issue #44 已关闭。现行需求为 V1.59 第 4.3 节，不能据下文旧停止点重复实施。
>
...
- `docs/一期/requirements/一期需求文档.md`：V1.59，正文第4.3节、状态/数量/权限/通知及验收更新。
- `docs/一期/project/一期技术设计方案.md`：核对独立存储、版本、事务、投影及逆向数量设计。
- `docs/一期/project/一期开发计划.md`：#44增量范围、顺序与并行边界。
- `docs/一期/project/work-orders/S07-正常装箱发货闭环.md`：页面方案、文件及核心测试范围。
- `docs/一期/project/work-orders/S08-发货清单作废退回与补发.md`：收货后退回/作废和原报导出边界。
- `docs/一期/project/work-orders/S11-通知提醒与审计收口.md`：工厂确认结果事件和现有微信模板映射。
- `docs/一期/project/一期里程碑与决策记录.md`：本轮规则、授权与证据边界。
- 本交接文件。
