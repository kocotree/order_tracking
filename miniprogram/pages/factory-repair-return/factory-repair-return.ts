...
Page({
  data: { repair: null as Repair | null, repairId: "", loading: true, previewMode: false, step: "edit" as "edit" | "preview", progress: 0, pending: 0, groups: [] as ReturnGroup[], previewLines: [] as PreviewLine[], previewGroups: [] as PreviewGroup[], repairedTotal: 0, scrappedTotal: 0, returnTotal: 0, submitting: false, idempotencyKey: "" },
