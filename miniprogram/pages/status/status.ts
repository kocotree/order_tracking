...
const CONTENT: Record<IdentityStatus, { mark: string; title: string; description: string; note: string; action: string }> = {
  identifying: { mark: "…", title: "正在识别身份", description: "正在确认账号身份，请稍候。", note: "身份识别完成后将自动进入下一步", action: "" },
  ...
  "logged-out": { mark: "退", title: "已退出登录", description: "当前登录会话已结束，账号绑定仍然保留。", note: "重新登录不会再次授权手机号", action: "重新登录" },
};
