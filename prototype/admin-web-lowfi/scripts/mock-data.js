...
export const pendingImportData = {
  ...
  fetchLogs: [],
  orders: [
    { orderNo: "E81", productName: "小护甲机能裤", category: "服装", tracker: "松子", trackers: ["松子", "青椒"], factory: "宇情", validationKey: "ready", validationLabel: "可导入", tone: "success", statusKey: "pending" },
