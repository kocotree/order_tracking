...
class OrderImportCandidate(Base):
    ...
    field_overrides: Mapped[dict[str, Any]] = mapped_column(JSON, nullable=False, default=dict)
    ...
    trackers: Mapped[list[str]] = mapped_column(JSON, nullable=False, default=list)
...
class OrderDetail(Base):
    ...
    source_trackers: Mapped[list[str]] = mapped_column(JSON, nullable=False, default=list)
    source_contract_ship_date: Mapped[date | None] = mapped_column(Date)
    contract_ship_date: Mapped[date | None] = mapped_column(Date)
    date_override_enabled: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
    factory_override_enabled: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
    shipped_override_enabled: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
